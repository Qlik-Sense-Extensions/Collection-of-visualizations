...
*/
var _extName = "network-chart-arrow";
				...
				settings: {
					...
					items: {
                        ...
                        arrowLocation: {
                            ...
                            options: 
                                [ { value: 'to' }, { value: 'from' }, { value: 'middle' }
                                ],
                            defaultValue: "to"
                        },
                        shadowMode: {
...
//console.log(dataSet);
                ...
                for(i = 0; i< dataSet.length; i++){
                    ...
                    if (layout.displayEdgeLabel) {
                        edges.push( { "from":dataSet[i].id, "to":dataSet[i].parentid, "value":dataSet[i].edgeValue, "label":dataSet[i].edgeText } ); // with labels
                    } else {
