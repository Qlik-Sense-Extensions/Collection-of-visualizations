        ...
        d3lasso: function(obj){
            ...
            function lasso() {
                ...
                function dragstart() {
                    ...
                    items._groups[0].forEach(function(d) {
                ...
                function dragmove() {
                    ...
                    var tx = (d3.mouse(this)[0] * scale.k) + scale.x;
                    var ty = (d3.mouse(this)[1] * scale.k) + scale.y;
                    ...
                    for (var i = path_length_start; i<=path_length_end; i++) {
                        ...
                        items._groups[0].filter(function(d) {
                            var a;
                    ...
                    if(isPathClosed === true && closePathSelect === true) {
                        ...
                        for (var i = 0; i<=close_path_length; i++) {
                            ...
                            items._groups[0].filter(function(d) {return d.lassoPoint.cy==Math.round(cur_pos.y);}).forEach(function(d) {
                        ...
                        items._groups[0].forEach(function(a) {
                    ...
                    // Tag possible items
                    d3.selectAll(items._groups[0].filter(function(d) {return (d.loopSelected && isPathClosed) || d.hoverSelected;}))
                ...
                function dragend() {
                    ...
                    items.nodes()
                        .forEach(function(d) {d.possible = false;});
