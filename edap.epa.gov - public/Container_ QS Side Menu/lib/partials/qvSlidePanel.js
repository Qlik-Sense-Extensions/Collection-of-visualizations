      ...
      link: function(scope, elem, attrs) {
        ...
        scope.$watch('qsSideFilters', function(newValue, oldValue, scope){ 
          ...
          var groups = newValue.map(function(group){
            var filterpane =  group.filterpane.map(function(target){return '<div class = \"col-md-12 filter\"><div  qsfilterid = "'+target.qInfo.qId+'" class=\"qsSideFilterTarget \" style = \"height: '+(34*target.childFilters)+'px; width: 100%;background-color: transparent;\"></div></div>'; });
