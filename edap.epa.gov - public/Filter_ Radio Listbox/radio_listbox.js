define( ["jquery", "qlik", "css!./style.css"], function ( $, qlik) {
	...
	return {
		...
		paint: function ( $element , layout) {
			...
			{
			var style ='style="width:'+(Split-1)+'% !important;float:left !important;font-size: '+Fontsize+'px;color:'+LabelTextColor+';text-align:'+LabelAlign+';padding:6px 0;overflow:hidden;"';
			...
			var style2 = 'style="width:'+(95)+'% !important'+';font-size: '+Fontsize+'px;color:'+LabelTextColor+';text-align:'+LabelAlign+';height:20px;line-height:24px"';
			
			
			var self = this, html = '<div class="radio-listbox-ext '+styletype+'" style="width:'+(overallwidth)+'% !important;overflow:auto !important;height:'+(height)+'px;">', style;
