		...
		paint: function ( $element,layout ) {
			...
			//not date or html input:
				...
				optionsforselect.forEach( function ( row ) {
					...
					var button_text = row[0].qText;
					if (pr.buttontext.length > 0) {
						button_text = pr.buttontext;
					}
					//list
					if (visType=='hlist' || visType=='vlist'){
						html += '<li class="sfe data '+selectedClass+defaultelementclass+otherdefaultelementclass+colorclasses+' state' + row[0].qState + ''+elementExtraClass+createLUIclass(pr.addLUIclasses,visType,pr.visInputFieldType)+'" dval="' + row[0].qElemNumber + '"'+elementstyle+' ' +elementExtraAttribute+ '>' + button_text;
						html += '</li>';
					//checkbox
					} else if (visType=='checkbox'){
						html += '<label'+elementstyle+' class="sfe">'
						html += '<input type="checkbox" class=" data state' + row[0].qState +defaultelementclass+otherdefaultelementclass+selectedClass+elementExtraClass+colorclasses+createLUIclass(pr.addLUIclasses,visType,pr.visInputFieldType)+ '" dval="' + row[0].qElemNumber + '"' + dis + checkedstatus +' ' +elementExtraAttribute+ '/> ' + button_text; //
						html += '</label>';
					//button
					} else if (visType=='btn'){
						html += '<button'+elementstyle+''
						html += ' class="sfe sfsbtn state' + row[0].qState +defaultelementclass+selectedClass+colorclasses+elementExtraClass+otherdefaultelementclass+ createLUIclass(pr.addLUIclasses,visType,pr.visInputFieldType)+'" dval="' + row[0].qElemNumber + '"' + dis + ' ' +elementExtraAttribute+ '>' + button_text; //
						html += '</button> ';
					//radio
					} else if (visType=='radio'){
						html += '<label'+elementstyle+' class="sfe">'
						html += '<input type="radio" name="sfs'+layout.qInfo.qId+'" class="state' + row[0].qState +defaultelementclass+elementExtraClass+otherdefaultelementclass+selectedClass+colorclasses+ '" dval="' + row[0].qElemNumber + '"' + dis + checkedstatus +' ' +elementExtraAttribute+ '/>' + button_text; //
						html += '</label>';
						...
						html += '<option '+elementstyle+'class="data state' + row[0].qState +defaultelementclass+otherdefaultelementclass+selectedClass+colorclasses+ '" dval="' + row[0].qElemNumber + '" value="' + row[0].qElemNumber + '"' + dis + dropselection + ' >' + button_text;
						html += '</option>';
					} else if (visType=='luiswitch'){
						html += '<div '+elementstyle+' class="sfe lui-switch" title="'+button_text+'"> <label class="lui-switch__label">';
						...
						html += '<div class="lui-switch_txt" style="">'+button_text+'</div>';
						html += '</div>';
					} else if (visType=='luicheckbox'){
						html += '<label '+elementstyle+' class="sfe lui-checkbox" title="'+button_text+'">';
						...
						html += '<div class="lui-checkbox__check-wrap"> <span class="lui-checkbox__check"></span> <span '+elementstyle+' class="lui-checkbox__check-text">' + button_text+'</span> </div>';
						html += '</label>';
					} else if (visType=='luiradio'){
						html += '<label '+elementstyle+' class="sfe lui-radiobutton" title="'+button_text+'">';
						...
						html += '<div class="lui-radiobutton__radio-wrap"> <span class="lui-radiobutton__radio"></span> <span '+elementstyle+' class="lui-radiobutton__radio-text">' + button_text+'</span> </div>';
						html += '</label>';
					}
