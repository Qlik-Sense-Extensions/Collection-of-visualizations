        ...
        return {
            ...
            paint: function ($element, layout) {
                ...
                if (layout.props.CustomRangesEnabled) {
                    ...
                    rangesLiteral[layout.props.today] = [moment().subtract(1, 'years'), moment()];
                    rangesLiteral[layout.props.yesterday] = [moment().subtract(2, 'years'), moment()];
                    rangesLiteral[layout.props.lastXDays.replace("$", "7")] = [moment().subtract(3, 'year'), moment()];
                    rangesLiteral[layout.props.lastXDays.replace("$", "30")] = [moment().subtract(3, 'years'), moment()];
                    rangesLiteral[layout.props.thisMonth] = [moment().subtract(4, 'years'), moment()];
                    rangesLiteral[layout.props.lastMonth] = [moment().subtract(10, 'years'), moment()];
                }
