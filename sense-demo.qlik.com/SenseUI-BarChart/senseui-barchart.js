...
'use strict';
	...
	me.paint = function($element,layout) {
		var vars = {
			v: '3.0.8', 
			id: layout.qInfo.qId,
			data: layout.qHyperCube.qDataPages[0].qMatrix.filter(function(d) { return d[1].qNum >= 0}),
			data2: layout.qHyperCube.qDataPages[0].qMatrix.filter(function(d) { return d[1].qNum >= 0}),
