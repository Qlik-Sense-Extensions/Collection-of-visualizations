$('#head0').attr('style','font-weight: bold; border: 1px solid black; color: rgb(255, 255, 255); background-color: rgb(0, 0, 255);');

$('#head1').attr('style','font-weight: bold; border: 1px solid black; color: rgb(255, 255, 255); background-color: rgb(0, 0, 255);');

$('#head2').attr('style','font-weight: bold; border: 1px solid black; color: rgb(255, 255, 255); background-color: rgb(0, 0, 255);');

$('#head3').attr('style','font-weight: bold; border: 1px solid black; color: rgb(255, 255, 255); background-color: rgb(0, 0, 255);');

$('#head4').attr('style','font-weight: bold; border: 1px solid black; color: rgb(255, 255, 255); background-color: rgb(0, 0, 255);');

$('#head5').attr('style','font-weight: bold; border: 1px solid black; color: rgb(255, 255, 255); background-color: rgb(0, 0, 255);');

$('#head6').attr('style','font-weight: bold; border: 1px solid black; color: rgb(255, 255, 255); background-color: rgb(0, 0, 255);');

$('#head7').attr('style','font-weight: bold; border: 1px solid black; color: rgb(255, 255, 255); background-color: rgb(0, 0, 255);');

$('#head8').attr('style','font-weight: bold; border: 1px solid black; color: rgb(255, 255, 255); background-color: rgb(0, 0, 255);');

$('#head9').attr('style','font-weight: bold; border: 1px solid black; color: rgb(255, 255, 255); background-color: rgb(0, 0, 255);');

$('#head10').attr('style','font-weight: bold; border: 1px solid black; color: rgb(255, 255, 255); background-color: rgb(0, 0, 255);');

$('#head11').attr('style','font-weight: bold; border: 1px solid black; color: rgb(255, 255, 255); background-color: rgb(0, 0, 255);');

$('#cell0_0').attr('style','border: 1px solid black;');

$('#cell0_1').attr('style','border: 1px solid black;');

$('#cell0_2').attr('style','border: 1px solid black;');

$('#cell0_3').attr('style','border: 1px solid black;');

$('#cell0_4').attr('style','border: 1px solid black;');

$('#cell0_5').attr('style','border: 1px solid black;');

$('#cell0_6').attr('style','border: 1px solid black;');

$('#cell0_7').attr('style','border: 1px solid black;');

$('#cell0_8').attr('style','border: 1px solid black;');

$('#cell0_9').attr('style','border: 1px solid black;');

$('#cell0_10').attr('style','border: 1px solid black;');

$('#cell0_11').attr('style','border: 1px solid black;');

$('#cell1_0').attr('style','border: 1px solid black;');

$('#cell1_1').attr('style','border: 1px solid black;');

$('#cell1_2').attr('style','border: 1px solid black;');

$('#cell1_3').attr('style','border: 1px solid black;');

$('#cell1_4').attr('style','border: 1px solid black;');

$('#cell1_5').attr('style','border: 1px solid black;');

$('#cell1_6').attr('style','border: 1px solid black;');

$('#cell1_7').attr('style','border: 1px solid black;');

$('#cell1_8').attr('style','border: 1px solid black;');

$('#cell1_9').attr('style','border: 1px solid black;');

$('#cell1_10').attr('style','border: 1px solid black;');

$('#cell1_11').attr('style','border: 1px solid black;');

$('#cell2_0').attr('style','border: 1px solid black;');

$('#cell2_1').attr('style','border: 1px solid black;');

$('#cell2_2').attr('style','border: 1px solid black;');

$('#cell2_3').attr('style','border: 1px solid black;');

$('#cell2_4').attr('style','border: 1px solid black;');

$('#cell2_5').attr('style','border: 1px solid black;');

$('#cell2_6').attr('style','border: 1px solid black;');

$('#cell2_7').attr('style','border: 1px solid black;');

$('#cell2_8').attr('style','border: 1px solid black;');

$('#cell2_9').attr('style','border: 1px solid black;');

$('#cell2_10').attr('style','border: 1px solid black;');

$('#cell2_11').attr('style','border: 1px solid black;');

$('#cell3_0').attr('style','border: 1px solid black;');
...
$('#cell4_0').attr('style','border: 1px solid black;');
...
$('#cell5_0').attr('style','border: 1px solid black;');
...
$('#cell6_0').attr('style','border: 1px solid black;');
...
$('#cell7_0').attr('style','border: 1px solid black;');
...
$('#cell8_0').attr('style','border: 1px solid black;');
...
$('#cell9_0').attr('style','border: 1px solid black;');
...
$('#cell10_0').attr('style','border: 1px solid black;');
...
$('#cell11_0').attr('style','border: 1px solid black;');

$('#cell11_1').attr('style','border: 1px solid black;');

$('#cell11_2').attr('style','border: 1px solid black;');

$('#cell11_3').attr('style','border: 1px solid black;');

$('#cell11_4').attr('style','border: 1px solid black;');

$('#cell11_5').attr('style','border: 1px solid black;');

$('#cell11_6').attr('style','border: 1px solid black;');

$('#cell11_7').attr('style','border: 1px solid black;');

$('#cell11_8').attr('style','border: 1px solid black;');

$('#cell11_9').attr('style','border: 1px solid black;');

$('#cell11_10').attr('style','border: 1px solid black;');

$('#cell11_11').attr('style','border: 1px solid black;');
