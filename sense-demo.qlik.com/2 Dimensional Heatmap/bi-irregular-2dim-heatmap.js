...
define(
    ...
    function ($, qlik, d3, lasso) {
        'use strict';
        // if (!$("link[href='https://sense-demo-staging.qlik.com/extensions/bi-irregular-2dim-heatmap/styles/bi-irregular-2dim-heatmap.css']").length) {
        //     $('<link href="https://sense-demo-staging.qlik.com/extensions/bi-irregular-2dim-heatmap/styles/bi-irregular-2dim-heatmap.css" rel="stylesheet">').appendTo("head");
        // }
        return {
            initialProperties: {
                version: 1.0,
